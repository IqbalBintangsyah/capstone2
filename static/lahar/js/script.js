...
var arrayLahar = [ lahar, lahar2, lahar3, lahar4, lahar5, lahar6 ];
// console.log(lahar2)
...
//_____________________persebaran lahar 3
var persebaranLahar3 = L.geoJSON(lahar3, {
    onEachFeature: function (feature, layer) {
        layer.bindPopup(`<b>Name: </b>` + feature.properties.name)
    },
    style: {
...
//_____________________persebaran lahar 4
var persebaranLahar4 = L.geoJSON(lahar4, {
    onEachFeature: function (feature, layer) {
        layer.bindPopup(`<b>Name: </b>` + feature.properties.name)
    },
    style: {
...
//_____________________persebaran lahar 5
var persebaranLahar5 = L.geoJSON(lahar5, {
    onEachFeature: function (feature, layer) {
        layer.bindPopup(`<b>Name: </b>` + feature.properties.name)
    },
    style: {
...
//_____________________persebaran lahar 6
var persebaranLahar6 = L.geoJSON(lahar6, {
    onEachFeature: function (feature, layer) {
        layer.bindPopup(`<b>Name: </b>` + feature.properties.name)
    },
    style: {
...
var overlayMaps = {
    ...
    '100rb m3': persebaranLahar,
    '200rb m3': persebaranLahar2,
    '500rb m3': persebaranLahar3,
    '1jt m3': persebaranLahar4,
    '2jt m3': persebaranLahar5,
    '3jt m3': persebaranLahar6
};
...
let apiUrl = 'http://127.0.0.1:8000/feature/laharapi/' //link sementara, nanti diubah sesuai origin
getData();
